...
```console
Usage: cltlk set action [OPTIONS] SUBCOMMAND
...
cltlk set action permission sandwichfarm tlkio.system voteproducer voting -p sandwichfarm@voting

#Now can execute the transaction with the previously set permissions. 
cltlk system voteproducer approve sandwichfarm someproducer -p sandwichfarm@voting
```
