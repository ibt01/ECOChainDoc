...
## Command
A set of TLKIO keys is required to create an account. The TLKIO keys can be generated by using `cltlk create key`.

```sh
cltlk create account inita tester TLK4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq TLK7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
