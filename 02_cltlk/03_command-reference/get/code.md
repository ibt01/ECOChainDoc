...
## Examples
Simply output the hash of tlkio.token contract 

```sh
cltlk get code tlkio.token
```
```console
...
```sh
cltlk get code tlkio.token -a tlkio.token.abi
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
...
Retrieve and save wast code for tlkio.token contract

```sh
cltlk get code tlkio.token -c tlkio.token.wast
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
saving wast to tlkio.token.wast
```
