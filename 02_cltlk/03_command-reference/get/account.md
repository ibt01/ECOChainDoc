...
### Get formatted data for user **tlkio**

```sh
cltlk get account tlkio
```
```console
privileged: true
permissions: 
...
producers:     <not voted>
```
### Get JSON data for user **tlkio**

```sh
cltlk get account tlkio --json
```
```json
{
  "account_name": "tlkio",
  ...
  "permissions": [{
      ...
      "required_auth": {
        "threshold": 1,
        "keys": [{
            "key": "TLK6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
            "weight": 1
          }
        ],
        "accounts": [],
